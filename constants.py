...
WHITELISTED_CHANNELS maps each allowed Slack channel ID to its name. It is
the single source of truth for channel access, read by both
AgentToolGateService (MCP tool channel checks) and SlackChannelSearchService
(post-filtering search.messages results).
