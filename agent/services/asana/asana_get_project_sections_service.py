"""Backs the `asana_get_project_sections` custom tool. Checked directly against
...
class AsanaGetProjectSectionsService:
    ...
    def get_project_sections(self, project_gid):
        ...
        try:
            return self.client.get(f'/projects/{project_gid}/sections', {'opt_fields': self.FIELDS})
        except AsanaApiError as error:
            return {'error': str(error)}


__all__ = ['AsanaGetProjectSectionsService']
